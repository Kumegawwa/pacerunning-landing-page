  ...
  return (
    <footer className="relative overflow-hidden bg-deep-gradient text-white">
      ...
      <div className="container-pace relative py-20 md:py-24">
        <div className="grid gap-12 md:grid-cols-12">
          ...
          <div className="md:col-span-3">
            ...
            <div className="mt-5 flex items-center gap-4">
              {/* O shrink-0 impede os icones de esmagarem/esticarem */}
              <a href={SITE.whatsapp} target="_blank" rel="noopener noreferrer" className="group flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-white/10 transition-all hover:bg-magenta hover:scale-110" aria-label="WhatsApp">
              ...
              <a href={SITE.instagram} target="_blank" rel="noopener noreferrer" className="group flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-white/10 transition-all hover:bg-magenta hover:scale-110" aria-label="Instagram">
              ...
              <a className="hover:text-magenta text-sm text-white/80 transition-colors truncate" href={`mailto:${SITE.email}`}>
                {SITE.email}
              </a>
            </div>
        ...
        <div className="mt-16 flex flex-col items-start justify-between gap-6 border-t border-white/15 pt-8 md:flex-row md:items-end w-full">
          
          {/* ASSINATURA EXATAMENTE COMO NO OPSDIESEL */}
          <div className="flex flex-col gap-1">
            <div className="text-sm text-white/60">© {new Date().getFullYear()} Pace Running Curitiba · CNPJ 23.770.147/0001-66</div>
            <div className="text-[11px] font-sans tracking-wider text-white/40 flex items-center gap-1.5 mt-1 select-none">
          ...
          <p className="text-xs text-white/55">Assessoria de corrida em Curitiba — Parque Barigui & Parque São José</p>
        </div>
      </div>
    </footer>
  );
